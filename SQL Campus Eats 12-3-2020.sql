...
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('1821563', '9 Melby Way', 'Bojangles', '10:00 AM - 9:00 PM', 'Bojangles.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('8098492', '69 Pleasure Parkway', 'Chick-Fil-A', '9:00 AM - 10:00 PM', 'ChickFilA.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('2112348', '04885 Mitchell Lane', 'Domino''s', '9:30 AM - 1:00 AM', 'Dominos.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('0832493', '4376 Texas Road', 'Einstein Bagels', '9:00 AM - 10:00 PM', 'EinsteinBagels.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('0395040', '3685 Bowman Court', 'Panda Express', '10:30 AM - 9:30 PM', 'PandaExpress.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('3220768', '6 Calypso Crossing', 'Subway', '9:30 AM - 1:00 AM', 'Subway.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('8480219', '86 Algoma Way', 'Wendy''s', '7:30 AM - 11:30 PM', 'Wendys.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('4477059', '46887 Oak Trail', 'Starbucks', '7:00 AM - 7:00 PM', 'Starbucks.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('2973548', '6208 La Follette Center', 'Mocha Joe''s', '6:00 AM - 7:00 PM', 'MochaJoes.com');
insert into restaurant (restaurant_id, location, restaurant_name, schedule, website) values ('1628540', '8487 Becker Street', 'Amelie’s', '7:00 AM - 10:00 PM', 'Amelies.com');
...
#Insert orders (30)
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 384568217, 1630682, 78749024, 1628540, 13.92, 5.0, '2020-08-16 19:03:41');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 600148417, 9619071, 78749024, 832493, 43.4, 5.0, '2020-02-02 15:50:02');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 433028227, 1630682, 94582593, 1821563, 8.97, 5.0, '2020-03-13 03:54:07');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 607380521, 5488949, 12050578, 2973548, 31.51, 5.0, '2020-11-18 06:54:53');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 471722937, 5777198, 1057062, 2973548, 26.02, 5.0, '2020-02-24 14:13:23');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 745285878, 323513, 44641030, 1821563, 12.41, 5.0, '2020-02-13 15:12:26');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 392401292, 2206298, 43759944, 8098492, 13.91, 5.0, '2020-06-01 12:20:22');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 354596389, 1630682, 43759944, 1821563, 32.01, 5.0, '2020-05-03 15:16:13');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 389452264, 2206298, 94582593, 395040, 35.31, 5.0, '2020-04-02 09:53:47');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 229241954, 1630682, 14597043, 8480219, 43.98, 5.0, '2020-08-26 11:13:03');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 395174232, 6137679, 44641030, 832493, 28.59, 5.0, '2020-07-26 05:39:08');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 969223224, 323513, 9558242, 1821563, 38.73, 5.0, '2020-04-01 14:50:00');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 37532649, 5777198, 94582593, 832493, 39.24, 5.0, '2020-01-16 18:58:31');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 392401292, 1630682, 78749024, 8480219, 10.82, 5.0, '2020-05-02 17:28:23');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 88874116, 323513, 43759944, 1821563, 13.1, 5.0, '2020-05-28 19:47:49');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 116131316, 8343877, 12050578, 395040, 37.56, 5.0, '2020-06-27 02:21:35');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 262961749, 5488949, 14597043, 832493, 26.22, 5.0, '2020-05-28 22:54:47');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 450955274, 8343877, 44641030, 832493, 25.74, 5.0, '2020-01-27 15:42:51');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 354596389, 2206298, 14597043, 8480219, 19.52, 5.0, '2020-05-28 09:59:41');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 914792982, 323513, 14597043, 1628540, 41.12, 5.0, '2020-05-05 17:44:40');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 891301945, 6137679, 1057062, 8098492, 30.42, 5.0, '2020-05-20 13:29:57');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 678920279, 5777198, 14597043, 2112348, 34.35, 5.0, '2020-05-11 23:29:10');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 288959979, 1630682, 9558242, 395040, 42.81, 5.0, '2020-01-24 05:14:05');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 824324885, 8343877, 9558242, 3220768, 33.15, 5.0, '2020-11-15 08:39:54');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 660060434, 1630682, 12050578, 2973548, 35.51, 5.0, '2020-08-18 01:01:37');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 163629780, 5488949, 94582593, 1628540, 30.52, 5.0, '2020-07-14 08:41:29');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 854820807, 323513, 14597043, 2973548, 39.86, 5.0, '2020-03-15 10:54:12');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 96442070, 9619071, 9558242, 1628540, 40.67, 5.0, '2020-03-16 22:43:49');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 668866984, 6137679, 14597043, 1821563, 18.33, 5.0, '2020-07-25 09:17:20');
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time) values (null, 754431000, 8343877, 14597043, 3220768, 27.24, 5.0, '2020-08-29 15:34:48');