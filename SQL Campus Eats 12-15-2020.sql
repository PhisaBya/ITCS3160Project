...
#Create person_index index
CREATE INDEX person_index
ON person(person_name);

#Create staff_position index
CREATE INDEX staff_position
ON staff(position);

#Create CustomerView
CREATE VIEW customer_view
AS SELECT location, restaurant_name, schedule, website, rating
FROM Restaurant;

#Create TopCustomersView
CREATE VIEW top_customer_view
AS SELECT person_name, person_email, COUNT(*) AS orders_placed
FROM person
INNER JOIN `order`
ON person.person_id = `order`.person_id
GROUP BY `order`.person_id
ORDER BY orders_placed DESC
LIMIT 3;

#Create DriverEarningsAdminView
CREATE VIEW total_driver_earnings_view
AS SELECT person.person_name AS driver_name, 
SUM(`order`.delivery_charge) AS total_delivery_earnings
FROM driver
INNER JOIN `order` ON `order`.driver_id = driver.driver_id
INNER JOIN student ON driver.student_id = student.student_id
INNER JOIN person ON student.person_id = person.person_id
GROUP BY driver_name
ORDER BY total_delivery_earnings DESC;
...
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('6042289', 229241954, 8343877, 94582593, 3220768, 12.04, 46.21, '2020-06-27 02:21:35', 3, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('3769161', 387630629, 6137679, 94582593, 395040, 49.98, 83.24, '2020-03-28 02:21:35', 2, 3);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('0319010', 811299842, 5488949, 78749024, 1628540, 44.72, 43.24, '2020-10-17 02:21:35', 1, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('0187187', 131749870, 9619071, 78749024, 2973548, 31.54, 91.71, '2020-12-07 02:21:35', 2, 5);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('4183881', 939947527, 5777198, 44641030, 4477059, 45.81, 51.04, '2020-11-07 22:21:35', 3, 3);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('3706592', 990829336, 8343877, 1057062, 832493, 43.01, 56.31, '2020-06-23 12:21:35', 4, 3);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('3652259', 678920279, 2206298, 43759944, 832493, 20.71, 69.24, '2020-10-15 12:21:35', 4, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('4863612', 404644109, 323513, 14597043, 8480219, 34.66, 76.71, '2020-09-27 13:21:35', 4, 5);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('4777939', 96442070, 1630682, 1057062, 8480219, 12.4, 92.24, '2020-06-21 14:21:35', 4, 3);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('9316071', 218412748, 5488949, 43759944, 2973548, 31.11, 59.71, '2020-03-27 02:21:35', 5, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('0924699', 811299842, 323513, 44641030, 832493, 19.34, 39, '2020-01-27 03:21:35', 3, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('2447666', 745285878, 323513, 1057062, 2973548, 19.75, 88.24, '2020-02-27 04:21:35', 5, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('1312983', 352916909, 8343877, 14597043, 395040, 16.17, 43.71, '2020-05-27 06:21:35', 2, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('3023020', 494695073, 9619071, 44641030, 1821563, 18.13, 26.24, '2020-03-27 03:21:35', 4, 3);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('1575030', 570447420, 323513, 1057062, 8480219, 6.56, 83.24, '2020-12-27 16:21:35', 4, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('4343652', 289697762, 2206298, 14597043, 2112348, 28.3, 88.24, '2020-06-25 22:21:35', 3, 1);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('4107358', 213497746, 1630682, 14597043, 832493, 6.5, 88.71, '2020-06-17 02:21:35', 4, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('7792745', 811299842, 2206298, 44641030, 1821563, 46.51, 53.71, '2020-06-22 21:21:35', 2, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('4239501', 378534493, 6137679, 78749024, 8098492, 44.49, 23.14, '2020-03-25 14:21:35', 4, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('1228137', 289697762, 1630682, 12050578, 3220768, 28.6, 84.31, '2020-01-27 02:21:35', 3, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('3183174', 115384265, 2206298, 9558242, 395040, 15.91, 43.12, '2020-06-27 02:21:35', 4, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('6110875', 113380940, 5777198, 14597043, 2112348, 10.81, 56.23, '2020-05-27 02:21:35', 5, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('8128604', 570447420, 323513, 12050578, 1821563, 17.9, 82.05, '2020-01-27 02:21:35', 3, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('6899013', 570447420, 2206298, 94582593, 2112348, 19.92, 3.0, '2020-02-27 02:21:35', 2, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('1783411', 463248379, 9619071, 9558242, 1628540, 22.81, 1, '2020-06-23 02:21:35', 3, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('9041949', 96442070, 1630682, 78749024, 8098492, 21.96, 5.71, '2020-03-17 15:21:35', 4, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('7442712', 384568217, 5488949, 1057062, 8098492, 18.98, 17.71, '2020-01-27 15:21:35', 4, 2);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('9442018', 180459633, 6137679, 9558242, 1628540, 21.52, 82.71, '2020-05-07 16:21:35', 5, 1);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('3500987', 471722937, 8343877, 1057062, 4477059, 40.11, 51.71, '2020-11-27 21:21:35', 4, 4);
insert into `order` (order_id, person_id, location_id, driver_id, restaurant_id, total_price, delivery_charge, delivery_time, restaurant_rating, driver_rating) values ('6104849', 324747907, 2206298, 43759944, 8480219, 37.85, 59.71, '2020-11-27 22:21:35', 3, 3);
